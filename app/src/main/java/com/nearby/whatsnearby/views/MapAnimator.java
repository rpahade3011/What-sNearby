...
public class MapAnimator {
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> routeLatLngList) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions()
                .add(routeLatLngList.get(0)).color(GREY).width(18);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(routeLatLngList.get(0)).color(BLACK).width(18);
        ...
        ObjectAnimator foregroundRouteAnimator = ObjectAnimator.ofObject(this,
                "routeIncreaseForward", new RouteEvaluator(), routeLatLngList.toArray());
