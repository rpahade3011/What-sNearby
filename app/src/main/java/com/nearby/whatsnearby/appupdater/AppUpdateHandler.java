...
import static com.nearby.whatsnearby.appupdater.Config.PLAY_STORE_HTML_TAGS_TO_GET_RIGHT_POSITION;
import static com.nearby.whatsnearby.appupdater.Config.PLAY_STORE_HTML_TAGS_TO_REMOVE_USELESS_CONTENT;
import static com.nearby.whatsnearby.appupdater.Config.PLAY_STORE_VARIES_W_DEVICE;
...
public class AppUpdateHandler {
    ...
    public void startCheckingUpdate() {
        String NETWORK_STATUS = NetworkUtil.getConnectivityStatusString(activity.getApplicationContext());
        if (NETWORK_STATUS.equals("Wifi enabled") || NETWORK_STATUS.equals("Mobile data enabled")) {
            ...
            request.setRetryPolicy(new DefaultRetryPolicy(GlobalSettings.DEFAULT_TIMEOUT_MS,
