...
public class GpsStatusDetector {
    ...
    private WeakReference<IGpsStatusDetectorCallBack> mCallBackWeakReference;

    public GpsStatusDetector(Activity activity) {
        this.mActivityWeakReference = new WeakReference<>(activity);
        this.mCallBackWeakReference = new WeakReference<>((IGpsStatusDetectorCallBack) activity);
    }

    public GpsStatusDetector(Fragment fragment) {
        this.mActivityWeakReference = new WeakReference<>(fragment.getActivity());
        this.mCallBackWeakReference = new WeakReference<>((IGpsStatusDetectorCallBack) fragment);
    }

    public void checkGpsStatus() {
        Activity activity = mActivityWeakReference.get();
        IGpsStatusDetectorCallBack callBack = mCallBackWeakReference.get();
    ...
    private void setLocationRequest(final Activity activity, final IGpsStatusDetectorCallBack callBack) {
